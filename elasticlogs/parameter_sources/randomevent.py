...
class RandomEvent:
    def __init__(self, params):
        ...
        self._time_interval = 'now'
        if 'time_interval' in params.keys():
            self._time_interval = self.__parse_date_range(params['time_interval'])
    ...
    def generate_event(self):
        ...
        timestruct = self.__generate_time_struct(self.__get_event_datetime())
